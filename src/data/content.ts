...
export const experience: Experience[] = [
  {
    ...
    highlights: [
      ...
      "Role-based access for 10+ staff via Supabase Row-Level Security and encrypted JWT, with zero unauthorized data-access incidents since launch.",
    ],
  },
  {
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    outcome:
      "A running system where every backup is a verified promise. The 26-test CI suite means no code ships without proving the restore works end-to-end, which is the kind of reliability signal that matters when someone's production database is gone.",
    metrics: [
  ...
  },
  {
    ...
    problem:
      "A busy Peshawar dental clinic was managing daily operations (appointments, patient records, billing, and prescriptions) across paper logs and disconnected spreadsheets. The staff of 10+ had no unified system, no audit trail, and no way to see the queue without walking to the front desk.",
    build: [
      ...
      "Supabase PostgreSQL backend with Row-Level Security enforcing role boundaries at the database level, so each staff member can only read and write what their role permits.",
